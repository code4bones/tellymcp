  ...
  public register(server: McpServer): void {
    server.registerTool(
      "ask_user_telegram",
      {
        ...
        description:
          "Send a clarification request to the Telegram user linked to the provided session and wait for a reply. Pass session_id explicitly after pairing; do not rely on implicit defaults unless cwd is also correct for this agent workspace.",
